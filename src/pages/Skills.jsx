...
const Skills = () => {
  return (
    <div className='mx-auto mt-28 flex max-w-6xl flex-col sm:mt-60'>
      <div className='font-mono text-2xl text-amber-200'><span className='text-white'>03</span>.Skills:-</div>
      <h1 className='mt-8 text-4xl font-bold sm:mt-10 sm:text-5xl md:text-6xl'>Technologies I <span className='text-cyan-400'>Know</span></h1>
      <div className='mt-16 grid grid-cols-1 gap-5 md:mx-8 md:grid-cols-2 lg:grid-cols-3'>
        <div className='border-l-2 border-cyan-400 bg-gray-900/60 p-6 transition-all duration-300 hover:-translate-y-1 hover:bg-gray-800'>
