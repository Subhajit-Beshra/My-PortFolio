...
const About = () => {
  return (
    <div className='mx-auto mt-28 flex max-w-6xl flex-col sm:mt-60'>
      <Reveal><div className='font-mono text-2xl text-amber-200'><span className='text-white'>02</span>.About Me:-</div></Reveal>
      <Reveal delay={80}><h1 className='mt-8 text-4xl font-bold sm:mt-10 sm:text-6xl'>Who I <span className='text-cyan-400'>Am</span></h1></Reveal>
      <div className='mt-10 flex flex-col items-center gap-12 text-xl md:flex-row md:items-start'>
        <Reveal className='max-w-2xl text-gray-300'>
          <div>
        ...
        <Reveal className='shrink-0' delay={140}>
          <div>
