...
const Contact = () => {
  return (
    <div className='mx-auto mt-28 flex max-w-6xl flex-col sm:mt-60'>
      <Reveal><div className='font-mono text-2xl text-amber-200'><span className='text-white'>05</span>.Contact:-</div></Reveal>
      <Reveal delay={80}><h1 className='mt-8 text-4xl font-bold sm:mt-10 sm:text-5xl md:text-6xl'>Let's   <span className='text-cyan-400'>Connect</span></h1></Reveal>
      <Reveal delay={140}><Form /></Reveal>
